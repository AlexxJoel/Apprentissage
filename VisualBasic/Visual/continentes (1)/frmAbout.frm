...
Private Sub Form_Load()
    ...
    lblDescription.Caption = "Descripcion del Programa: " & _
    "Aqui encontramos tres continentes cada uno de ellos tiene 4 paises visualisando una foto de : Mapa , Bandera y Algo representacion"
