    ...
    <?php
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">Herrera Hernandez Joel Alejandro</p>
                <p class="masthead-subheading font-weight-light mb-0">Aguario Diaz Jose Miguel</p>
            </div>
        </header>
        <!-- Portfolio Section-->
