...
<body>
	<header class="encabezado">
		...
		<div class="Reglas">
			<h2>REGISTROS DE BECAS</h2>
				...
				EN ESTA PAGINA SOLO PODRAS VER EL REGISTRO BUSCADO , SI DESEAS REALIZAR ALGUNA ACCIÓN : DA CLICK EN EL BOTON DE ACTUALIZAR O SIMPLEMENTE ELIMINAR</p>
				<p><b>1.</b> PODRAS AÑADIR REGISTROS..</p>
				<p><b>2.</b> BUSCAR  CUALQUIER REGISTRO MEDIANTE EL NUMERO DE CONTROL ANTES DE ELIMINAR O EDITAR</p>
				<p><b>3.</b> ELIMINAR REGISTROS.</p>
				<p><b>4.</b> PODRAS ACTUALIZAR REGISTROS..</p>
	

		</div>

	 <form action="../Usuario/formu.php">
	 	<div class="form">
	 		<h4>Puede agregar un nuevo registro</h4>
	...
	<h4>CONSULTA</h4>
				...
				<div class="grupo"> <!-- BIGINT -->
						...
						<input type="text"  maxlength="14" name="numerocontrol" required placeholder="Ingresa 14 Numeros">
				</div>

					<button type="submit" name="consulta">Consultar</button>
				    <button type="submit" name="Elimiar" onclick="return ConfDelete()">Eliminar</button>				    
	...
	<h4>DIRECCIÓN DEL ALUMNO(A)</h4>
			...
			<?php } ?>
					...
					<button type="submit" name="Act">Actualizar Datos</button>
						<h4>Primero haz la consulta</h4>
		...
		<form action="verificacion.php" method="POST">
			...
			<div class="form">  
				...
				<button type="submit" name="salirs">Salir de la Sesión</button>
		...
		<div class="Foter-pag">
				<div class="copy">
					Copyright CETis No. 44 <!--Joel y Mike-->
				</div>
		</div>
	</footer>
</body>
