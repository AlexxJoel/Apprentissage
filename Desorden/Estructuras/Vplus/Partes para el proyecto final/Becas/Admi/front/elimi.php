                        ...
                        <div class="container-fluid text-dark">
                            ...
                            <!-- Page Heading -->
                             <div class="align-items-center mb-4">
                                <h1 class="h3 mb-0 text-gray-800 font-italic">Eliminar:</h1>
                            </div>
                                         ...
                                         <form id="actuar">
                                                ...
                                                <div class="card-body text-justify" >                                           
                                                      <div class="form-group">
                                                          ...
                                                          <input type="text" name="codigoget" class="form-control" maxlength="14" required id="codigoe"  minlength="14">
                                                      </div>
                                                </div>
                                            </div>
                                            <div class="col-5">
                                                ...
                                                <button class="btn btn-danger btn-block mt-5" name="post" id="elimidirec">
