            ...
            <div id="wrapper">
                ...
                <ul class="navbar-nav sidebar sidebar-dark accordion toggled " id="accordionSidebar" style="background-color: #FC6128">
                   ...
                   <!--  <li class="nav-item text-left">
                    ...
                    <!-- Nav Item - Tables -->
                    <li class="nav-item">
                        <a class="nav-link text-ligth" href="correo.php">
                        ...
                        <div class="container-fluid text-dark">
                            ...
                            <!-- Page Heading -->
                             <div class="align-items-center mb-4">
                                <h1 class="h3 mb-0 text-gray-800 font-italic">Envio de correo:</h1>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="card shadow mb-4">
                                        ...
                                        <a  class="card-header py-3 d-flex nav-link">
                                            <h6 class="m-0 font-weight-bold d-inline-block flex-grow-1 mr-5" style="color: #FA8128">Reporte
                                            </h6>
                                        ...
                                        <div class="card-body row ">                                  
                                             <!-- <div class=""> --> <!-- d-flex justify-content-center  -->
                                              <form action="enviar.php" method="POST" name="enviar" class="col-12 row">

                                                    <div class="col-lg-6">
                                                        <div class="form-group">            
                                                            <label class=" col-form-label"><b><span class="text-danger">*</span>Correo:</b></label>
                                                            <input required type="text" name="correo" class="form-control">
                                                        </div> 
                                                        <div class="form-group">
                                                            <label><b><span class="text-danger">*</span>Asunto:</b></label>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <label><b><span class="text-danger">*</span>Mensaje:</b></label>
                                                            <textarea required name="msj" class="form-control"></textarea>
                                                        </div>  
