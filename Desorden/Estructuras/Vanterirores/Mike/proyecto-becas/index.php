        ...
        <center>
          ...
          <table width=28% border="0">
             <tr>
                 ...
                 <td><input type="text" onkeypress="return solonumeros(event)" minlenght="14" maxlength="14" name="no_control"/></td>
             </tr>
              <tr>
                  <td>Semestre</td>
            ...
            <table width=28% border="0">
                <tr>
                    ...
                    <td>
                      ...
                      <input type="text" onblur="validarInput(this)"  placeholder="Ingrese su CURP"
                      maxlength="18">
                ...
                <tr>
                    ...
                    <td><input type="text" required="true" placeholder="Evita usar acentos" name="apellido_paterno"></td> <!--Condición para convertir las letras a Mayusculas-->
                </tr>
                <tr>
                    <td>Apellido Materno</td>  <!-- VARCHAR -->
                    <td><input type="text" required="true" placeholder="Evita usar acentos" name="apellido_materno"></td> <!--Condición para convertir las letras a Mayusculas-->
                </tr>
                <tr>
            ...
            <table>
                ...
                <tr>
                    <td>Entidad</td>  <!-- VARCHAR -->
                        <td><select name="entidad" required="true">
                            ...
                            <option value="morr">MOREEEEEE</option>
                ...
                <tr>
                    ...
                    <td><input type="text" name="descripcion_ubicacion" required="true"</td>
                </tr>
                <tr>
