...
<body>
	<header class="encabezado">
		<nav>
			...
			<div class="gris">Bienvenido REGÍSTRATE</div>
			<div class="enlaces">
				<!-- <ul>
	...
	<h4>Ingresa todos tus datos en mayúsculas</h4>
				...
				<div class="grupo"> <!-- VARCHAR -->
					<label>Curp del estudiante</label>
						...
						<a href='https://www.gob.mx/curp/#tab-02'>¿No conoces tu CURP?</a>				
				</div>

						<!--  Por si no se saben su crup -->
	...
	<h4>Asegúrate que tus datos sean correctos</h4>
				...
				<div class="grupo"> <!-- VARCHAR -->
					...
					<button type="submit" name="revisar">Siguiente</button>
