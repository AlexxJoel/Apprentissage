...
<body>
	...
	<h5>Datos actuales</h5>
				...
				<div class="grupo"> <!-- BIGINT -->
						...
						<input type="text" onkeypress="return solonumeros(event)"  maxlength="14" name="id" required placeholder="Ingresa 18 Numeros">
				</div>	
	...
	<h5>Ingresa todos tus datos en mayusculas</h5>
				...
				<div class="grupo">  <!-- DATE -->
					<label>Fecha de Nacimiento</label>
						<input type="date" required name="fecha_nacimiento"></td>
				</div>
	...
	<h5>Asegurate que tus datos sean correctoa</h5>
				...
				<div class="grupo"> <!-- MEDIUM-INT -->
					<label>Número exterior</label>
						<input type="text" onkeypress="return solonumeros(event)" name="numero_exterior" placeholder="S/N=Dejalo en blanco" >
				</div>

				<div class="grupo"> <!-- MEDIUM-INT -->
					<label>Número Interior</label>
						<input type="text" onkeypress="return solonumeros(event)" name="numero_interior" placeholder="S/N=Dejalo en blanco" >
				</div>
				...
				<div class="grupo"> <!-- VARCHAR -->
                    ...
                    <script type="text/javascript">
                        ...
                        function ConfirmarEnviar()
                            {
                                var respuesta= confirm("¿Estás seguro al 100% de que tus datos son los correctos?")
					...
					<button type="submit" name="enviar" onclick="return ConfirmarEnviar()">Registarse</button>
