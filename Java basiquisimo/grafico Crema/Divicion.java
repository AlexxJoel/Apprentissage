...
public abstract class Divicion implements ActionListener
{
JButton bt1;//creando variables globales de los botones
     ...
     */ 
    public Divicion(){//constructor de la clase 
    ...
    Divicion gj = new Divicion() {};//uso de constructor para la ventana
    } 
