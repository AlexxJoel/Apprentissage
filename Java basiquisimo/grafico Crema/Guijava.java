...
public Guijava (){ //constructor de la clase
 ...
 //cambiando color , tamaño de borde 
 ...
 //añadiendo el listener a los botones para manipulr los eventos del click
 ...
 jf.setSize(400,150);//cONFIGUARA EL TAMAÑO
...
public static void main (String[]args){
    Guijava gj = new Guijava(){}; // uso de constructor de la ventana
