...
public abstract class Triangulo implements ActionListener
{
JButton bt1;//creando variables globales de los botones
    ...
    Triangulo gj = new Triangulo() {};//uso de constructor para la ventana
    } 
...
public void actionPerformed(ActionEvent e) {//sobreescribimos el metodo del listener
        ...
        if(e.getSource()==bt1 && jt3.getText().equals("")){//podemos comparar por el contenido del boton
            ...
            r = 3.1416 * n1 * n1; //realizamos la operacion
