...
public abstract class Retsagui implements ActionListener{
...
public Retsagui (){ //constructor de la clase
...
public static void main (String[]args){
    Retsagui gj = new Retsagui(){}; // uso de constructor de la ventana
