...
public abstract class Multiplicacion implements ActionListener
{
JButton bt1;//creando variables globales de los botones
     ...
     */ 
    public Multiplicacion(){//constructor de la clase 
    ...
    Multiplicacion gj = new Multiplicacion() {};//uso de constructor para la ventana
    } 
