...
public abstract class Divigu implements ActionListener{
...
public Divigu (){ //constructor de la clase
...
public static void main (String[]args){
    Divigu gj = new Divigu(){}; // uso de constructor de la ventana
    
}
public void actionPerformed(ActionEvent e){//sobreescribimos el metodo del listener
    Double n1,n2,nr ;//variables donde se almacena el numero introducido
