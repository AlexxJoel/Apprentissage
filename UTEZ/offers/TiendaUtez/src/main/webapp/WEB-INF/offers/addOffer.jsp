    ...
    <main class="container-fluid">
        ...
        <div class="row ">
            <div class="col col-lg-3 col-md-3 col-sm-12 col-12  p-2">
                <h1 id="titulo">Informacion de la oferta</h1>
                ...
                <div class="col col-6">
                    <table class="table" id="tabla">
                        ...
                        <tr>
                            <td><%= produc.getName()%></td>
                            <td><%= produc.getCategory().getName()%></td>
                            <td><img src="data:image/jpeg;base64, <%= produc.getImageToShow()%> " class="img-fluid" alt="Imagen<%= produc.getName()%>"></td>
                            <td>
                                <a class="btn btn-primary" href="ProductServlet?accion=addOfferProduct&id_products=<%=produc.getId_products()%>&id_offers=0">Quitar</a>
                            </td>
                        </tr>
