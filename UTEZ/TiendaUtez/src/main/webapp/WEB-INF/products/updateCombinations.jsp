                ...
                <div class="col col-lg-5 col-md-6 col-sm-12 col-12 ">
                    ...
                    <div class="mt-2 sticky-top">
                        <div class="row  ">
                            ...
                            <div class="col-12 col-lg-11 col-md-12  p-0 px-md-2  mb-1">
                                <div class="input-group input-group-sm ">
                                    <span class="input-group-text alert-success alert fw-semibold">Categoria</span>
                            ...
                            <div class="col-12 col-lg-11 col-md-12 p-0 px-md-2 mb-3">
                                <span class="input-group-text alert-success alert fw-semibold p-1 m-0">Descripcion breve del producto</span>
                            ...
                            <div class="col-12 col-lg-11 col-md-12 p-0 px-md-2 ">
                                <span class="input-group-text alert-success alert fw-semibold p-1 m-0 ">Descripcion Larga</span>
