...
<head>
    ...
    <%@include file="../templateProduct/header.jsp"%>
</head>
<body>
<header>
    <%@include file="../../administrator/templateAdmin/navRoot.jsp"%>
</header>
...
<div class="p-4 mt-1 rounded rounded-3 " id="fondo">
    ...
    <div id="fondo-blanco" class="rounded p-4 shadow">
        ...
        <main class="container-fluid   ">
            ...
            <form class="row" action="ImageProductServlet" method="post" enctype="multipart/form-data">
                <!---------------------- Lado izquierdo ----------------------------->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="container-fluid d-flex justify-content-end">
                            ...
                            <button type="button"  class="btn   btn-block  m-2 btn-primary"  >Regresar</button>

                            <button type="submit"  class="btn   btn-block  m-2 btn-primary enviar" value="guardar" >Guardar</button>

                            <button type="submit"  class="btn  btn-block  m-2  btn-primary enviar" value="guardaryenviar"  >Guardar y publicar</button>
...
<%@include file="../templateProduct/footer.jsp"%>
